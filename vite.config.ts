...
const VARIANT_META: Record<string, {
  ...
  full: {
    title: 'LateLink Map - Global Intelligence & Live News Dashboard',
    description: 'AI-powered global intelligence dashboard with live news channels from every country, conflict zones tracking, markets, military monitoring, and geopolitical data.',
    keywords: 'LateLink Map, live news channels, world countries, global intelligence, Bangladesh news, Jomuna News, Channel 24, Asian TV, T Sports, conflict zones, real-time monitoring, OSINT, live TV, country news',
    url: 'https://latelink-map.vercel.app/',
    siteName: 'LateLink Map',
    shortName: 'LateLinkMap',
    subject: 'Global Intelligence, Live News & Country Dashboard',
    classification: 'Intelligence Dashboard, Live TV Channels, Country News Aggregator',
    categories: ['news', 'productivity'],
    features: [
      'Country-specific live news channels',
      'Bangladeshi TV channels',
      'Global conflict zones tracking',
      'Real-time news aggregation',
      'Military tracking & OSINT',
      'Earthquake alerts',
      'Infrastructure monitoring',
      'Geopolitical intelligence',
      'Default map views for capitals',
      'Market tracking',
    ],
  },
  tech: {
